    ...
    methods(Access = private)
        ...
        function outputFcn(obj,Global)
            ...
            if Global.evaluated >= Global.evaluation
                ...
                %save(fullfile(folder,sprintf('%s_%s_M%d_D%d_S%d_%d.mat',func2str(Global.algorithm),class(Global.problem),Global.M,Global.D,Global.save,Global.run)),'result','metric');
            end
        end
        %% Table to excel
