...
% l --- 3 --- Upper bound of decision variables
...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function obj = PS2()
            % Parameter setting
            [lower,upper,obj.l] = obj.Global.ParameterSet(-10,10,3);
            ...
            obj.Normal = [-1*ones(1,obj.l),zeros(1,obj.Global.D-obj.l)];
            % Generate vertexes
            obj.Points = [eye(obj.l),zeros(obj.l,obj.Global.D-obj.l)];
            obj.Points = [obj.Points;(-1/obj.l)*obj.Normal+(((obj.l+1:obj.Global.M)'-obj.l)/obj.l)*obj.Normal];
            obj.XStandard = obj.Points(1,:);
        end
        ...
        function PopCon = CalCon(obj,PopDec)
            PopCon = ((PopDec-obj.XStandard)*(obj.Normal)'./(obj.Normal*(obj.Normal)'));
        end
