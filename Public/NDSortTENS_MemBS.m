function [FrontNo,MaxFNo,CountComp] = NDSortTENS_MemBS(varargin)
...
%--------------------------------------------------------------------------
    ...
    PopObj2 = varargin{2};
    nSort  = varargin{3};
    [FrontNo,MaxFNo,CountComp] = T_ENS_Mem_BS(PopObj1,PopObj2,nSort);
end

function [FrontNo,MaxFNo,CountComp] = T_ENS_Mem_BS(PopObj1,PopObj2,nSort)
    CountComp = 0;
