function [FrontNo,MaxFNo,CountComp,Relation] = NDSortTENS(varargin)
...
%--------------------------------------------------------------------------
    ...
    nSort  = varargin{3};
    Relation = varargin{4};
    [FrontNo,MaxFNo,CountComp] = T_ENS(PopObj,nSort);
end

function [FrontNo,MaxFNo,CountComp] = T_ENS(PopObj,nSort)
    CountComp = 0;
