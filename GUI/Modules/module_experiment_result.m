...
%--------------------------------------------------------------------------
    ...
    methods
        ...
        function name = filename(obj,a,p,r)
            ...
            %name = fullfile(obj.Folder,obj.Algorithms{a,1},sprintf('%s_%s_M%d_D%d_S%d_%d.mat',obj.Algorithms{a,1},obj.Problems{p,1},obj.Problems{p,3}{2},obj.Problems{p,3}{3},obj.nPops,r));
        end
